...
export const adminRegisterController = async (req, res) => {
  try {
    const { name, email, password, phone, address, answer, adminKey } = req.body;
    ...
    // optional admin registration key gate
    if (process.env.ADMIN_REG_KEY && adminKey !== process.env.ADMIN_REG_KEY) {
